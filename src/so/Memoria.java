...
public class Memoria {
    ...
    /** Tamanho ta pagina em bytes. O tamanho 8 foi definido pelo professor **/
    private final int tam_pag = 8;
    /** Numero de paginas FISICAS. Aquantidade 16 foi definido pelo professor **/
    private final int qtd_pag_f = 16;
    /** Numero de paginas VIRTUAIS. Aquantidade 32 foi definido pelo professor **/
    private final int qtd_pag_v = 32;
    /** escopo_mem_f é a matriz 16x8 que mostrará o escopo da memória FISICA. */
    private int escopo_mem_f[][] = new int[qtd_pag_f][tam_pag];
    /** escopo_mem_v é a matriz 32x8 que mostrará o escopo da memória VIRTUAL. */
    private int escopo_mem_v[][] = new int [qtd_pag_v][tam_pag];
    ...
    public void escopo_v()
    {
        ...
        So.insereDadosArquivo(So.getTime()+"%nESCOPO MEMORIA VIRTUAL:%n");
        for ( lin = 0; lin < qtd_pag_v ; lin++ )
        {
            for ( col = 0; col < tam_pag ; col++ )
            {
    ...
    public void escopo_f()
    {
        ...
        So.insereDadosArquivo(So.getTime()+" ESCOPO MEMORIA FISICA:%n");
